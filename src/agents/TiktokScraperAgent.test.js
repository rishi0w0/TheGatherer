const { scrapeTikTok } = require('../src/agents/TikTokScraperAgent');
...
describe('scrapeTikTok', () => {
  ...
  it('should scrape TikTok data using Puppeteer', async () => {
    ...
    await scrapeTikTok('username', 'password', 'targetProfile', '01-01-2021 to 01-01-2022');

    expect(saveData).toHaveBeenCalledWith('TikTok', {
      profile: {
        username: 'test_user',
        followers: '100',
        following: '50',
